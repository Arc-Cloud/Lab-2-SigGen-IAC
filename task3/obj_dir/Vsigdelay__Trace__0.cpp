...
void Vsigdelay___024root__trace_chg_sub_0(Vsigdelay___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        bufp->chgSData(oldp+0,(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count1),9);
        bufp->chgSData(oldp+1,(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count2),9);
        bufp->chgCData(oldp+2,(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count1),8);
        bufp->chgCData(oldp+3,(vlSelf->sigdelay__DOT____Vcellout__addrCounter__count2),8);
    }
    bufp->chgBit(oldp+4,(vlSelf->clk));
    bufp->chgBit(oldp+5,(vlSelf->rst));
    bufp->chgBit(oldp+6,(vlSelf->wr));
    bufp->chgBit(oldp+7,(vlSelf->rd));
    bufp->chgCData(oldp+8,(vlSelf->offset),8);
    bufp->chgCData(oldp+9,(vlSelf->mic_signal),8);
    bufp->chgCData(oldp+10,(vlSelf->delayed_signal),8);
}
