...
VL_INLINE_OPT void Vsinegen___024root___sequent__TOP__0(Vsinegen___024root* vlSelf) {
    ...
    // Init
    CData/*7:0*/ __Vdly__sinegen__DOT__adress1;
    // Body
    __Vdly__sinegen__DOT__adress1 = vlSelf->sinegen__DOT__adress1;
    vlSelf->dout1 = vlSelf->sinegen__DOT__myRom__DOT__rom_array
        [vlSelf->sinegen__DOT__adress1];
    vlSelf->dout2 = vlSelf->sinegen__DOT__myRom__DOT__rom_array
        [vlSelf->sinegen__DOT__adress2];
    if (vlSelf->rst) {
        __Vdly__sinegen__DOT__adress1 = 0U;
        vlSelf->sinegen__DOT__adress2 = 0U;
    } else if (vlSelf->en) {
        __Vdly__sinegen__DOT__adress1 = (0xffU & ((IData)(1U) 
                                                  + (IData)(vlSelf->sinegen__DOT__adress1)));
        vlSelf->sinegen__DOT__adress2 = (0xffU & (((IData)(1U) 
                                                   + (IData)(vlSelf->sinegen__DOT__adress1)) 
                                                  - (IData)(vlSelf->incr)));
    }
    vlSelf->sinegen__DOT__adress1 = __Vdly__sinegen__DOT__adress1;
}
